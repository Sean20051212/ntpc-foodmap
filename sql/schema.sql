...
-- 4.1 行政區（新北市 29 區完整資料）
-- 中心經緯度 = 該區所有餐廳座標的 median（餐廳密度中心，非地理幾何中心）
-- 來源：data.ntpc.gov.tw Open Data CSV (800 筆) + newtaipei.travel API (700 筆) 合併
INSERT INTO `districts` (`zipcode`, `district_name`, `center_latitude`, `center_longitude`) VALUES
('207', '萬里區', 25.2049600, 121.6890200),
('208', '金山區', 25.2215800, 121.6380800),
('220', '板橋區', 25.0130300, 121.4633100),
('221', '汐止區', 25.0677300, 121.6517000),
('222', '深坑區', 25.0014500, 121.6134800),
('223', '石碇區', 24.9909000, 121.6604300),
('224', '瑞芳區', 25.1086600, 121.8435900),
('226', '平溪區', 25.0249600, 121.7387200),
('227', '雙溪區', 25.0364900, 121.8657300),
('228', '貢寮區', 25.0357850, 121.9264950),
('231', '新店區', 24.9692700, 121.5386900),
('232', '坪林區', 24.9350250, 121.7089150),
('233', '烏來區', 24.8629800, 121.5513400),
('234', '永和區', 25.0074400, 121.5149500),
('235', '中和區', 24.9962950, 121.5070350),
('236', '土城區', 24.9812450, 121.4499000),
('237', '三峽區', 24.9330100, 121.3708300),
('238', '樹林區', 24.9896200, 121.4188900),
('239', '鶯歌區', 24.9537650, 121.3494700),
('241', '三重區', 25.0643400, 121.4941150),
('242', '新莊區', 25.0351800, 121.4527800),
('243', '泰山區', 25.0561600, 121.4336400),
('244', '林口區', 25.0772800, 121.3880000),
('247', '蘆洲區', 25.0841400, 121.4719000),
('248', '五股區', 25.0977500, 121.4348700),
('249', '八里區', 25.1566700, 121.4233050),
('251', '淡水區', 25.1714400, 121.4402500),
('252', '三芝區', 25.2550700, 121.4945600),
('253', '石門區', 25.2863500, 121.5306250);

-- 4.2 相鄰關係（zipcode_a < zipcode_b 正規化，共 46 條邊）
