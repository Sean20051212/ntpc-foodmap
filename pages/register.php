...
function RegisterPage() {
  ...
  const uErr = (submitted || u) && (u.length < 3 || u.length > 20) ? "帳號需為 3-20 字元" : "";
  const pErr = (submitted || p) && p && p.length < 6 ? "密碼至少需 6 字元" : "";
      ...
      <div className="auth-wrap">
        {done ? (
          <div className="auth-card" style={{textAlign: "center"}}>
            ...
            <p className="auth-sub" style={{textAlign: "center"}}>即將為你跳轉到登入頁…</p>
          </div>
        ) : (
          <form className="auth-card" onSubmit={submit} noValidate>
            ...
            <div className="field" style={{marginBottom: 14}}>
              <div className="field-row">
                ...
                <span className="label-hint">3-20 字元</span>
              </div>
              <input id="rg-u"
            ...
            <div className="field" style={{marginBottom: 14}}>
              <div className="field-row">
                ...
                <span className="label-hint">至少 6 字元</span>
              </div>
              <input id="rg-p"
            ...
            <button className="btn btn-primary btn-block btn-lg" type="submit">註冊</button>
